...
// $Rev: 52393 $
// File generated on 17.10.2016 16:07:11 from Type Library described below.
...
// *********************************************************************//
  ITestPropDisp = dispinterface
    ...
    procedure Set0(const AVal: WideString); dispid 1610743811;
    property Get0[out AVal: Integer]: Integer dispid 1610743812;
  end;
